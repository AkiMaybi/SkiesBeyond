    ...
    public static final RegistryEntry<ArmorMaterial> SOLAR_ARMOR_MATERIAL = registerArmorMaterial("solar",
            () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
                ...
                map.put(ArmorItem.Type.BODY, 4);
                    ...
                    List.of(new ArmorMaterial.Layer(Identifier.of(SkiesBeyond.MOD_ID, "solar"))), 0, 0));

    public static RegistryEntry<ArmorMaterial> registerArmorMaterial(String name, Supplier<ArmorMaterial> material) {
        return Registry.registerReference(Registries.ARMOR_MATERIAL, Identifier.of(SkiesBeyond.MOD_ID, name), material.get());
    }
}
