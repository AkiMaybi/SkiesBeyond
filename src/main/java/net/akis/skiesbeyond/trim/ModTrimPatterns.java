...
public class ModTrimPatterns {
    public static final RegistryKey<ArmorTrimPattern> SUNLIGHT = RegistryKey.of(RegistryKeys.TRIM_PATTERN,
            Identifier.of(SkiesBeyond.MOD_ID, "sunlight"));

    public static void bootstrap(Registerable<ArmorTrimPattern> context) {
        register(context, ModItems.SUNLIGHT_SMITHING_TEMPLATE, SUNLIGHT);
    }
